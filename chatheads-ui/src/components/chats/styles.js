...
export const ConversationWrapper = styled.div`
  ...
  @media ${styleVals.breakpoints.tabletLandscape},
    ${styleVals.breakpoints.tabletPortrait} {
    flex-direction: row;
  }
`;
...
export const UsernameLabel = styled.p`
  ...
  margin-top: ${(props) =>
    props.shiftDown
      ? styleVals.dimensions.spacing18
      : styleVals.dimensions.spacing0};
...
export const ChatheadsCircles = styled.div`
  ...
  margin-bottom: ${(props) =>
    props.index === props.chatheadsLength - 1
      ? styleVals.dimensions.spacing12
      : styleVals.dimensions.spacing0};
  margin-left: auto;
  margin-right: auto;
...
export const SearchInputWrapper = styled.div`
  ...
  margin-bottom: ${(props) =>
    props.search
      ? styleVals.dimensions.spacing38
      : styleVals.dimensions.spacing6};
  @media ${styleVals.breakpoints.tabletLandscape},
    ${styleVals.breakpoints.tabletPortrait} {
    width: auto;
    margin-bottom: ${(props) =>
      props.search
        ? styleVals.dimensions.spacing12
        : styleVals.dimensions.spacing14};
  }
`;
...
export const UpdateButtonWrapper = styled.div`
  margin-top: ${(props) =>
    props.shiftDown
      ? styleVals.dimensions.spacing24
      : styleVals.dimensions.spacing4};
