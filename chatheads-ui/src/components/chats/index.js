...
const Chats = (props) => {  
    ...
    const ChatDisplay = <ChatWrapper {...props}>
      {selectedChat
      ? <React.Fragment>
    ...
    const ChatheadsList = <React.Fragment>
      {!searchText
    ...
    const ProfileChatsOptions = () => <DetailsWrapper theme={props.theme}>
        <ProfileTitle
          onClick={()=>setShowChats(false)}
          isClicked={!showChats}
          theme = {props.theme}>{chatConstants.PROFILE_TITLE}
        </ProfileTitle>  
        <ChatsTitle
          onClick={()=>setShowChats(true)}
          isClicked={showChats}
          theme = {props.theme}>{chatConstants.CHATS_TITLE}
        </ChatsTitle>                                              
      </DetailsWrapper>
