...
const mapDispatchToProps = (dispatch) => {
  return {
    initiateSignUp: (signUpDetails) =>
      dispatch(actions.signUpActions.initiateSignUp(signUpDetails)),
...
const SignUp = (props) => {
  ...
  const SignUpFields = (
    <AlertWithLoginWrapper>
      {alert.showAlert && (
        <AlertBox theme={props.theme}>{alert.message}</AlertBox>
      )}
      ...
      <form onSubmit={handleSignUp}>
        <LoginWrapper {...props}>
          ...
          <SignUpButtonWrapper
            ...
            {...props}
            disabled={
              props.homeData.status === "failure" || !props.homeData.status
            }
          >
  ...
  return (
    <React.Fragment>
      {error.isAlert && (
        <AlertWrapper>
          <AlertBox theme={props.theme}>{error.message}</AlertBox>
        </AlertWrapper>
      )}
